...
export const Chain: { [chainId in ChainId]?: ChainConfig } = {
  [ChainId.Ethereum]: {
    ...
    fetchAddressData: ({ address }) =>
      covalent.balanceOf({ address, chainId: ChainId.Ethereum }),
  ...
  [ChainId.Fantom]: {
    ...
    fetchAddressData: ({ address }) =>
      covalent.balanceOf({ address, chainId: ChainId.Fantom }),
  ...
  [ChainId.Avalanche]: {
    ...
    fetchAddressData: ({ address }) =>
      covalent.balanceOf({ address, chainId: ChainId.Avalanche }),
  ...
  [ChainId.Arbitrum]: {
    ...
    fetchAddressData: ({ address }) =>
      covalent.balanceOf({ address, chainId: ChainId.Arbitrum }),
    fetchAddressNFTs: ({ address }) =>
      new Promise((_, reject) => reject('Chain not supported yet')),
    validateAddress: validateEVMAddress,
  },
  [ChainId.BSC]: {
    ...
    fetchAddressData: ({ address }) =>
      covalent.balanceOf({ address, chainId: ChainId.BSC }),
  ...
  [ChainId.Polygon]: {
    ...
    fetchAddressData: ({ address }) =>
      covalent.balanceOf({ address, chainId: ChainId.Polygon }),
